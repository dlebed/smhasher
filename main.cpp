...
void xmsx1 ( const void * key, int len, uint32_t seed, void * out )
{
  const unsigned char *data = (const unsigned char *)key;
...
void xmsx2 ( const void * key, int len, uint32_t seed, void * out )
{
  const unsigned char *data = (const unsigned char *)key;
  constexpr uint64_t m = 0x2e0bb864e9ea7df5ULL;
  uint64_t h = seed;
...
void xmsx3 ( const void * key, int len, uint32_t seed, void * out )
{
  const unsigned char *data = (const unsigned char *)key;
  constexpr uint64_t m = 0xaf47d47c99b1461bULL;
  uint64_t h = seed;
...
#define FNV2_VERIF           0x1967C625
      ...
      { xmsx,            32, 0xBE207D97, "xmsx", "XMSX-0xcdb32970830fcaa1ULL", POOR, {} },
      { xmsx1,            32, 0xBE207D97, "xmsx1", "XMSX-0xc6a4a7935bd1e995ULL", POOR, {} },
      { xmsx2,            32, 0xBE207D97, "xmsx2", "XMSX-0x2e0bb864e9ea7df5ULL", POOR, {} },
      { xmsx3,            32, 0xBE207D97, "xmsx3", "XMSX-0xaf47d47c99b1461bULL", POOR, {} },
